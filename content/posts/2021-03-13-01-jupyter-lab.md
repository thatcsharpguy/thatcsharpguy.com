...
```
    ...
    CPU times: user 1.27 ms, sys: 1.32 ms, total: 2.6 ms
    Wall time: 6.01 s
...
```
    ...
    1.45 µs ± 634 ns per loop (mean ± std. dev. of 7 runs, 10 loops each)
...
```
    ...
    [<matplotlib.lines.Line2D at 0x11f0e3250>]

![png](01-jupyter-lab_files/01-jupyter-lab_24_1.png)
...
```
    ...
    [<matplotlib.lines.Line2D at 0x11f2af220>]
